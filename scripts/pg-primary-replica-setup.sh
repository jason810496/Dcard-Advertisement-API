...
docker cp .env/dev/postgresql.conf primary:/var/lib/postgresql/data/postgresql.conf
...
cp -r ./stateful_volumes/dev/primary_copy/* ./stateful_volumes/dev/replica/
